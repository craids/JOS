...
static int init_stack_with_addr(envid_t child, const char **argv, uintptr_t *init_esp, uint32_t stack_addr);
...
//For exec, with stack option
static int
init_stack_with_addr(envid_t child, const char **argv, uintptr_t *init_esp, uint32_t stack)
{
	size_t string_size;
	int argc, i, r;
	char *string_store;
