...
umain(int argc, char **argv)
{
  ...
  800075:	c7 44 24 08 c4 30 80 	movl   $0x8030c4,0x8(%esp)
  80007c:	00 
  80007d:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  800084:	00 
  800085:	c7 04 24 dc 30 80 00 	movl   $0x8030dc,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800120:	c7 04 24 f8 30 80 00 	movl   $0x8030f8,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002e8:	0f be 80 1b 31 80 00 	movsbl 0x80311b(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004af:	c7 44 24 08 33 31 80 	movl   $0x803133,0x8(%esp)
  8004b6:	00 
  ...
  800501:	b8 2c 31 80 00       	mov    $0x80312c,%eax
