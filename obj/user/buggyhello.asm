...
exit(void)
{
  ...
  80009a:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80009d:	e8 f8 05 00 00       	call   80069a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80011a:	00 
  80011b:	c7 44 24 08 6a 26 80 	movl   $0x80266a,0x8(%esp)
  800122:	00 
  800123:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012a:	00 
  80012b:	c7 04 24 87 26 80 00 	movl   $0x802687,(%esp)
  800132:	e8 9f 16 00 00       	call   8017d6 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001ac:	00 
  8001ad:	c7 44 24 08 6a 26 80 	movl   $0x80266a,0x8(%esp)
  8001b4:	00 
  8001b5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001bc:	00 
  8001bd:	c7 04 24 87 26 80 00 	movl   $0x802687,(%esp)
  8001c4:	e8 0d 16 00 00       	call   8017d6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800252:	00 
  800253:	c7 44 24 08 6a 26 80 	movl   $0x80266a,0x8(%esp)
  80025a:	00 
  80025b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800262:	00 
  800263:	c7 04 24 87 26 80 00 	movl   $0x802687,(%esp)
  80026a:	e8 67 15 00 00       	call   8017d6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a5:	00 
  8002a6:	c7 44 24 08 6a 26 80 	movl   $0x80266a,0x8(%esp)
  8002ad:	00 
  8002ae:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b5:	00 
  8002b6:	c7 04 24 87 26 80 00 	movl   $0x802687,(%esp)
  8002bd:	e8 14 15 00 00       	call   8017d6 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002f8:	00 
  8002f9:	c7 44 24 08 6a 26 80 	movl   $0x80266a,0x8(%esp)
  800300:	00 
  800301:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800308:	00 
  800309:	c7 04 24 87 26 80 00 	movl   $0x802687,(%esp)
  800310:	e8 c1 14 00 00       	call   8017d6 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80034b:	00 
  80034c:	c7 44 24 08 6a 26 80 	movl   $0x80266a,0x8(%esp)
  800353:	00 
  800354:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80035b:	00 
  80035c:	c7 04 24 87 26 80 00 	movl   $0x802687,(%esp)
  800363:	e8 6e 14 00 00       	call   8017d6 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003c0:	00 
  8003c1:	c7 44 24 08 6a 26 80 	movl   $0x80266a,0x8(%esp)
  8003c8:	00 
  8003c9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003d0:	00 
  8003d1:	c7 04 24 87 26 80 00 	movl   $0x802687,(%esp)
  8003d8:	e8 f9 13 00 00       	call   8017d6 <_panic>
...
sys_exec(uint32_t eip, uint32_t esp, void * v_ph, uint32_t phnum)
{
  ...
  80046c:	83 ec 2c             	sub    $0x2c,%esp
	...
	asm volatile("int %1\n"
  80046f:	be 00 00 00 00       	mov    $0x0,%esi
  800474:	b8 12 00 00 00       	mov    $0x12,%eax
  800479:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  80047c:	8b 55 08             	mov    0x8(%ebp),%edx
  80047f:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800482:	8b 7d 14             	mov    0x14(%ebp),%edi
  ...
  800489:	7e 28                	jle    8004b3 <sys_exec+0x4d>
		panic("syscall %d returned %d (> 0)", num, ret);
  80048b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80048f:	c7 44 24 0c 12 00 00 	movl   $0x12,0xc(%esp)
  800496:	00 
  800497:	c7 44 24 08 6a 26 80 	movl   $0x80266a,0x8(%esp)
  80049e:	00 
  80049f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8004a6:	00 
  8004a7:	c7 04 24 87 26 80 00 	movl   $0x802687,(%esp)
  8004ae:	e8 23 13 00 00       	call   8017d6 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8005af:	8b 04 95 14 27 80 00 	mov    0x802714(,%edx,4),%eax
  ...
  8005ca:	c7 04 24 98 26 80 00 	movl   $0x802698,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800659:	e8 c6 fb ff ff       	call   800224 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800757:	e8 75 fa ff ff       	call   8001d1 <sys_page_map>
  ...
  800792:	e8 3a fa ff ff       	call   8001d1 <sys_page_map>
...
err:
  ...
  8007bb:	e8 64 fa ff ff       	call   800224 <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80081f:	c7 04 24 d9 26 80 00 	movl   $0x8026d9,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8008f7:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8009b0:	c7 04 24 b8 26 80 00 	movl   $0x8026b8,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800c06:	c7 44 24 0c 28 27 80 	movl   $0x802728,0xc(%esp)
  800c0d:	00 
  800c0e:	c7 44 24 08 2f 27 80 	movl   $0x80272f,0x8(%esp)
  800c15:	00 
  800c16:	c7 44 24 04 9b 00 00 	movl   $0x9b,0x4(%esp)
  800c1d:	00 
  800c1e:	c7 04 24 44 27 80 00 	movl   $0x802744,(%esp)
  800c25:	e8 ac 0b 00 00       	call   8017d6 <_panic>
	assert(r <= PGSIZE);
  800c2a:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800c2f:	7e 24                	jle    800c55 <devfile_write+0xa5>
  800c31:	c7 44 24 0c 4f 27 80 	movl   $0x80274f,0xc(%esp)
  800c38:	00 
  800c39:	c7 44 24 08 2f 27 80 	movl   $0x80272f,0x8(%esp)
  800c40:	00 
  800c41:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
  800c48:	00 
  800c49:	c7 04 24 44 27 80 00 	movl   $0x802744,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800c90:	c7 44 24 0c 28 27 80 	movl   $0x802728,0xc(%esp)
  800c97:	00 
  800c98:	c7 44 24 08 2f 27 80 	movl   $0x80272f,0x8(%esp)
  800c9f:	00 
  800ca0:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800ca7:	00 
  800ca8:	c7 04 24 44 27 80 00 	movl   $0x802744,(%esp)
  800caf:	e8 22 0b 00 00       	call   8017d6 <_panic>
	assert(r <= PGSIZE);
  800cb4:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800cb9:	7e 24                	jle    800cdf <devfile_read+0x84>
  800cbb:	c7 44 24 0c 4f 27 80 	movl   $0x80274f,0xc(%esp)
  800cc2:	00 
  800cc3:	c7 44 24 08 2f 27 80 	movl   $0x80272f,0x8(%esp)
  800cca:	00 
  800ccb:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800cd2:	00 
  800cd3:	c7 04 24 44 27 80 00 	movl   $0x802744,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800da6:	c7 44 24 04 5b 27 80 	movl   $0x80275b,0x4(%esp)
  800dad:	00 
...
alloc_sockfd(int sockid)
{
  ...
  800eac:	e8 cc f2 ff ff       	call   80017d <sys_page_alloc>
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  8011c7:	c7 44 24 0c 67 27 80 	movl   $0x802767,0xc(%esp)
  8011ce:	00 
  8011cf:	c7 44 24 08 2f 27 80 	movl   $0x80272f,0x8(%esp)
  8011d6:	00 
  8011d7:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  8011de:	00 
  8011df:	c7 04 24 7c 27 80 00 	movl   $0x80277c,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801225:	c7 44 24 0c 88 27 80 	movl   $0x802788,0xc(%esp)
  80122c:	00 
  80122d:	c7 44 24 08 2f 27 80 	movl   $0x80272f,0x8(%esp)
  801234:	00 
  801235:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  80123c:	00 
  80123d:	c7 04 24 7c 27 80 00 	movl   $0x80277c,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8012c0:	c7 44 24 04 94 27 80 	movl   $0x802794,0x4(%esp)
  8012c7:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  801310:	e8 0f ef ff ff       	call   800224 <sys_page_unmap>
  ...
  801328:	e8 f7 ee ff ff       	call   800224 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801386:	c7 04 24 9b 27 80 00 	movl   $0x80279b,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8013c4:	75 41                	jne    801407 <devpipe_write+0x6b>
			...
			sys_yield();
  8013c6:	e8 93 ed ff ff       	call   80015e <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801444:	75 31                	jne    801477 <devpipe_read+0x63>
			...
			sys_yield();
  801446:	e8 13 ed ff ff       	call   80015e <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  8014b7:	e8 c1 ec ff ff       	call   80017d <sys_page_alloc>
  ...
  8014f1:	e8 87 ec ff ff       	call   80017d <sys_page_alloc>
  ...
  801520:	e8 58 ec ff ff       	call   80017d <sys_page_alloc>
  ...
  801559:	e8 73 ec ff ff       	call   8001d1 <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801640:	c7 44 24 04 b3 27 80 	movl   $0x8027b3,0x4(%esp)
  801647:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80169d:	e8 0e ea ff ff       	call   8000b0 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8016c7:	eb 2a                	jmp    8016f3 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8016c9:	e8 90 ea ff ff       	call   80015e <sys_yield>
	int c;
  ...
  8016d0:	e8 f9 e9 ff ff       	call   8000ce <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80170f:	e8 9c e9 ff ff       	call   8000b0 <sys_cputs>
}
  801714:	c9                   	leave  
  801715:	c3                   	ret    
...
opencons(void)
{
  ...
  8017a8:	e8 d0 e9 ff ff       	call   80017d <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8017e7:	e8 53 e9 ff ff       	call   80013f <sys_getenvid>
  ...
  801802:	c7 04 24 c0 27 80 00 	movl   $0x8027c0,(%esp)
  ...
  801818:	e8 51 00 00 00       	call   80186e <vcprintf>
	cprintf("\n");
  80181d:	c7 04 24 ac 27 80 00 	movl   $0x8027ac,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  801859:	e8 52 e8 ff ff       	call   8000b0 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8018c2:	e8 e9 e7 ff ff       	call   8000b0 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8019c8:	0f be 80 e3 27 80 00 	movsbl 0x8027e3(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801b8f:	c7 44 24 08 fb 27 80 	movl   $0x8027fb,0x8(%esp)
  801b96:	00 
  ...
  801baf:	c7 44 24 08 41 27 80 	movl   $0x802741,0x8(%esp)
  801bb6:	00 
  ...
  801be1:	b8 f4 27 80 00       	mov    $0x8027f4,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80226e:	e8 20 e1 ff ff       	call   800393 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8022e6:	e8 85 e0 ff ff       	call   800370 <sys_ipc_try_send>
	if (r == 0) return;
  ...
  8022f5:	e8 64 de ff ff       	call   80015e <sys_yield>
  ...
  80230c:	e8 5f e0 ff ff       	call   800370 <sys_ipc_try_send>
		pg = (void *) KERNBASE;
