...
umain(int argc, char **argv)
{
  ...
  800054:	c7 04 24 60 26 80 00 	movl   $0x802660,(%esp)
...
exit(void)
{
  ...
  8000ad:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000b0:	e8 15 10 00 00       	call   8010ca <close_all>
	sys_env_destroy(0);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 78 26 80 00 	movsbl 0x802678(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800373:	ff 24 8d c0 27 80 00 	jmp    *0x8027c0(,%ecx,4)
  ...
  80041f:	c7 44 24 08 90 26 80 	movl   $0x802690,0x8(%esp)
  800426:	00 
  ...
  80043f:	c7 44 24 08 5d 2a 80 	movl   $0x802a5d,0x8(%esp)
  800446:	00 
  ...
  800471:	b8 89 26 80 00       	mov    $0x802689,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b40:	00 
  800b41:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800b48:	00 
  800b49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b50:	00 
  800b51:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd2:	00 
  800bd3:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800bda:	00 
  800bdb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800be2:	00 
  800be3:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c25:	00 
  800c26:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800c2d:	00 
  800c2e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c35:	00 
  800c36:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c78:	00 
  800c79:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800c80:	00 
  800c81:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c88:	00 
  800c89:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ccb:	00 
  800ccc:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800cd3:	00 
  800cd4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cdb:	00 
  800cdc:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d1e:	00 
  800d1f:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800d26:	00 
  800d27:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d2e:	00 
  800d2f:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d71:	00 
  800d72:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800d79:	00 
  800d7a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d81:	00 
  800d82:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800de6:	00 
  800de7:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800dee:	00 
  800def:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800df6:	00 
  800df7:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_exec(uint32_t eip, uint32_t esp, void * v_ph, uint32_t phnum)
{
  ...
  800ebc:	00 
  800ebd:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800ec4:	00 
  800ec5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ecc:	00 
  800ecd:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800fdf:	8b 04 95 30 2a 80 00 	mov    0x802a30(,%edx,4),%eax
  ...
  800fea:	a1 0c 40 80 00       	mov    0x80400c,%eax
  800fef:	8b 40 48             	mov    0x48(%eax),%eax
  800ff2:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  800ff6:	89 44 24 04          	mov    %eax,0x4(%esp)
  800ffa:	c7 04 24 b4 29 80 00 	movl   $0x8029b4,(%esp)
  801001:	e8 60 f1 ff ff       	call   800166 <cprintf>
	*dev = 0;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80123f:	a1 0c 40 80 00       	mov    0x80400c,%eax
  801244:	8b 40 48             	mov    0x48(%eax),%eax
  801247:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80124b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80124f:	c7 04 24 f5 29 80 00 	movl   $0x8029f5,(%esp)
  801256:	e8 0b ef ff ff       	call   800166 <cprintf>
		return -E_INVAL;
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801317:	a1 0c 40 80 00       	mov    0x80400c,%eax
  80131c:	8b 40 48             	mov    0x48(%eax),%eax
  80131f:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801323:	89 44 24 04          	mov    %eax,0x4(%esp)
  801327:	c7 04 24 11 2a 80 00 	movl   $0x802a11,(%esp)
  80132e:	e8 33 ee ff ff       	call   800166 <cprintf>
		return -E_INVAL;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8013ce:	75 23                	jne    8013f3 <ftruncate+0x63>
		cprintf("[%08x] ftruncate %d -- bad mode\n",
			thisenv->env_id, fdnum);
  8013d0:	a1 0c 40 80 00       	mov    0x80400c,%eax
	struct Fd *fd;
	if ((r = fd_lookup(fdnum, &fd)) < 0
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
		return r;
  ...
  8013e0:	c7 04 24 d4 29 80 00 	movl   $0x8029d4,(%esp)
  8013e7:	e8 7a ed ff ff       	call   800166 <cprintf>
			thisenv->env_id, fdnum);
		return -E_INVAL;
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801636:	c7 44 24 0c 44 2a 80 	movl   $0x802a44,0xc(%esp)
  80163d:	00 
  80163e:	c7 44 24 08 4b 2a 80 	movl   $0x802a4b,0x8(%esp)
  801645:	00 
  801646:	c7 44 24 04 9b 00 00 	movl   $0x9b,0x4(%esp)
  80164d:	00 
  80164e:	c7 04 24 60 2a 80 00 	movl   $0x802a60,(%esp)
  801655:	e8 ac 0b 00 00       	call   802206 <_panic>
	assert(r <= PGSIZE);
  80165a:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80165f:	7e 24                	jle    801685 <devfile_write+0xa5>
  801661:	c7 44 24 0c 6b 2a 80 	movl   $0x802a6b,0xc(%esp)
  801668:	00 
  801669:	c7 44 24 08 4b 2a 80 	movl   $0x802a4b,0x8(%esp)
  801670:	00 
  801671:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
  801678:	00 
  801679:	c7 04 24 60 2a 80 00 	movl   $0x802a60,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8016c0:	c7 44 24 0c 44 2a 80 	movl   $0x802a44,0xc(%esp)
  8016c7:	00 
  8016c8:	c7 44 24 08 4b 2a 80 	movl   $0x802a4b,0x8(%esp)
  8016cf:	00 
  8016d0:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  8016d7:	00 
  8016d8:	c7 04 24 60 2a 80 00 	movl   $0x802a60,(%esp)
  8016df:	e8 22 0b 00 00       	call   802206 <_panic>
	assert(r <= PGSIZE);
  8016e4:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8016e9:	7e 24                	jle    80170f <devfile_read+0x84>
  8016eb:	c7 44 24 0c 6b 2a 80 	movl   $0x802a6b,0xc(%esp)
  8016f2:	00 
  8016f3:	c7 44 24 08 4b 2a 80 	movl   $0x802a4b,0x8(%esp)
  8016fa:	00 
  8016fb:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801702:	00 
  801703:	c7 04 24 60 2a 80 00 	movl   $0x802a60,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8017d6:	c7 44 24 04 77 2a 80 	movl   $0x802a77,0x4(%esp)
  8017dd:	00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801bf7:	c7 44 24 0c 83 2a 80 	movl   $0x802a83,0xc(%esp)
  801bfe:	00 
  801bff:	c7 44 24 08 4b 2a 80 	movl   $0x802a4b,0x8(%esp)
  801c06:	00 
  801c07:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  801c0e:	00 
  801c0f:	c7 04 24 98 2a 80 00 	movl   $0x802a98,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801c55:	c7 44 24 0c a4 2a 80 	movl   $0x802aa4,0xc(%esp)
  801c5c:	00 
  801c5d:	c7 44 24 08 4b 2a 80 	movl   $0x802a4b,0x8(%esp)
  801c64:	00 
  801c65:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  801c6c:	00 
  801c6d:	c7 04 24 98 2a 80 00 	movl   $0x802a98,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801cf0:	c7 44 24 04 b0 2a 80 	movl   $0x802ab0,0x4(%esp)
  801cf7:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801d6e:	89 55 e4             	mov    %edx,-0x1c(%ebp)
	...
	while (1) {
		n = thisenv->env_runs;
  801d71:	a1 0c 40 80 00       	mov    0x80400c,%eax
  ...
  801d93:	0f b6 c2             	movzbl %dl,%eax
		nn = thisenv->env_runs;
  801d96:	8b 0d 0c 40 80 00    	mov    0x80400c,%ecx
  ...
  801db6:	c7 04 24 b7 2a 80 00 	movl   $0x802ab7,(%esp)
  801dbd:	e8 a4 e3 ff ff       	call   800166 <cprintf>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  802070:	c7 44 24 04 cf 2a 80 	movl   $0x802acf,0x4(%esp)
  802077:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  802232:	c7 04 24 dc 2a 80 00 	movl   $0x802adc,(%esp)
  802239:	e8 28 df ff ff       	call   800166 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80223e:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  802242:	8b 45 10             	mov    0x10(%ebp),%eax
  802245:	89 04 24             	mov    %eax,(%esp)
  802248:	e8 b8 de ff ff       	call   800105 <vcprintf>
	cprintf("\n");
  80224d:	c7 04 24 6c 26 80 00 	movl   $0x80266c,(%esp)
  802254:	e8 0d df ff ff       	call   800166 <cprintf>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8022a1:	a1 0c 40 80 00       	mov    0x80400c,%eax
  ...
  8022af:	a1 0c 40 80 00       	mov    0x80400c,%eax
  8022b4:	8b 40 78             	mov    0x78(%eax),%eax
  8022b7:	89 03                	mov    %eax,(%ebx)

	return thisenv->env_ipc_value;
  8022b9:	a1 0c 40 80 00       	mov    0x80400c,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802331:	c7 44 24 08 00 2b 80 	movl   $0x802b00,0x8(%esp)
  802338:	00 
  802339:	c7 44 24 04 48 00 00 	movl   $0x48,0x4(%esp)
  802340:	00 
  802341:	c7 04 24 0e 2b 80 00 	movl   $0x802b0e,(%esp)
