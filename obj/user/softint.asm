...
exit(void)
{
  ...
  800085:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800088:	e8 fd 05 00 00       	call   80068a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800105:	00 
  800106:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  80010d:	00 
  80010e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800115:	00 
  800116:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  80011d:	e8 a4 16 00 00       	call   8017c6 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800197:	00 
  800198:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  80019f:	00 
  8001a0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001a7:	00 
  8001a8:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  8001af:	e8 12 16 00 00       	call   8017c6 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ea:	00 
  8001eb:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  8001f2:	00 
  8001f3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001fa:	00 
  8001fb:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  800202:	e8 bf 15 00 00       	call   8017c6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80023d:	00 
  80023e:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  800245:	00 
  800246:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80024d:	00 
  80024e:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  800255:	e8 6c 15 00 00       	call   8017c6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800290:	00 
  800291:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  800298:	00 
  800299:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a0:	00 
  8002a1:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  8002a8:	e8 19 15 00 00       	call   8017c6 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e3:	00 
  8002e4:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  8002eb:	00 
  8002ec:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f3:	00 
  8002f4:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  8002fb:	e8 c6 14 00 00       	call   8017c6 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800336:	00 
  800337:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  80033e:	00 
  80033f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800346:	00 
  800347:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  80034e:	e8 73 14 00 00       	call   8017c6 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003ab:	00 
  8003ac:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  8003b3:	00 
  8003b4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003bb:	00 
  8003bc:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  8003c3:	e8 fe 13 00 00       	call   8017c6 <_panic>
...
sys_e1000_transmit(char *pkt, size_t length)
{
  ...
  8003fa:	b8 0f 00 00 00       	mov    $0xf,%eax
  8003ff:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
sys_e1000_receive(char *pkt, size_t *length)
{
  ...
  80041b:	b8 10 00 00 00       	mov    $0x10,%eax
...
sys_e1000_get_mac(uint8_t *mac_addr)
{
  ...
  80043c:	b8 11 00 00 00       	mov    $0x11,%eax
...
sys_exec(uint32_t eip, uint32_t esp, void * v_ph, uint32_t phnum)
{
  ...
  80045f:	b8 12 00 00 00       	mov    $0x12,%eax
  800464:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800467:	8b 55 08             	mov    0x8(%ebp),%edx
  80046a:	8b 5d 10             	mov    0x10(%ebp),%ebx
  80046d:	8b 7d 14             	mov    0x14(%ebp),%edi
  ...
  800474:	7e 28                	jle    80049e <sys_exec+0x4d>
		panic("syscall %d returned %d (> 0)", num, ret);
  800476:	89 44 24 10          	mov    %eax,0x10(%esp)
  80047a:	c7 44 24 0c 12 00 00 	movl   $0x12,0xc(%esp)
  800481:	00 
  800482:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  800489:	00 
  80048a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800491:	00 
  800492:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  800499:	e8 28 13 00 00       	call   8017c6 <_panic>
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800649:	e8 c1 fb ff ff       	call   80020f <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800747:	e8 70 fa ff ff       	call   8001bc <sys_page_map>
  ...
  800782:	e8 35 fa ff ff       	call   8001bc <sys_page_map>
...
err:
  ...
  8007ab:	e8 5f fa ff ff       	call   80020f <sys_page_unmap>
	return r;
...
alloc_sockfd(int sockid)
{
  ...
  800e9c:	e8 c7 f2 ff ff       	call   800168 <sys_page_alloc>
...
devpipe_close(struct Fd *fd)
{
  ...
  801300:	e8 0a ef ff ff       	call   80020f <sys_page_unmap>
  ...
  801318:	e8 f2 ee ff ff       	call   80020f <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8013b4:	75 41                	jne    8013f7 <devpipe_write+0x6b>
			...
			sys_yield();
  8013b6:	e8 8e ed ff ff       	call   800149 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801434:	75 31                	jne    801467 <devpipe_read+0x63>
			...
			sys_yield();
  801436:	e8 0e ed ff ff       	call   800149 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  8014a7:	e8 bc ec ff ff       	call   800168 <sys_page_alloc>
  ...
  8014e1:	e8 82 ec ff ff       	call   800168 <sys_page_alloc>
  ...
  801510:	e8 53 ec ff ff       	call   800168 <sys_page_alloc>
  ...
  801549:	e8 6e ec ff ff       	call   8001bc <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80168d:	e8 09 ea ff ff       	call   80009b <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8016b7:	eb 2a                	jmp    8016e3 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8016b9:	e8 8b ea ff ff       	call   800149 <sys_yield>
	int c;
  ...
  8016c0:	e8 f4 e9 ff ff       	call   8000b9 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  8016ff:	e8 97 e9 ff ff       	call   80009b <sys_cputs>
}
  801704:	c9                   	leave  
  801705:	c3                   	ret    
...
opencons(void)
{
  ...
  801798:	e8 cb e9 ff ff       	call   800168 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8017d7:	e8 4e e9 ff ff       	call   80012a <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  801849:	e8 4d e8 ff ff       	call   80009b <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8018b2:	e8 e4 e7 ff ff       	call   80009b <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80225e:	e8 1b e1 ff ff       	call   80037e <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8022d6:	e8 80 e0 ff ff       	call   80035b <sys_ipc_try_send>
	if (r == 0) return;
  ...
  8022e5:	e8 5f de ff ff       	call   800149 <sys_yield>
  ...
  8022fc:	e8 5a e0 ff ff       	call   80035b <sys_ipc_try_send>
		pg = (void *) KERNBASE;
