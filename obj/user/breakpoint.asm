...
exit(void)
{
  ...
  800084:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800087:	e8 fe 05 00 00       	call   80068a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800104:	00 
  800105:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  80010c:	00 
  80010d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800114:	00 
  800115:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  80011c:	e8 a5 16 00 00       	call   8017c6 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800196:	00 
  800197:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  80019e:	00 
  80019f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001a6:	00 
  8001a7:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  8001ae:	e8 13 16 00 00       	call   8017c6 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001e9:	00 
  8001ea:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  8001f1:	00 
  8001f2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001f9:	00 
  8001fa:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  800201:	e8 c0 15 00 00       	call   8017c6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80023c:	00 
  80023d:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  800244:	00 
  800245:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80024c:	00 
  80024d:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  800254:	e8 6d 15 00 00       	call   8017c6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80028f:	00 
  800290:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  800297:	00 
  800298:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80029f:	00 
  8002a0:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  8002a7:	e8 1a 15 00 00       	call   8017c6 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e2:	00 
  8002e3:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  8002ea:	00 
  8002eb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f2:	00 
  8002f3:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  8002fa:	e8 c7 14 00 00       	call   8017c6 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800335:	00 
  800336:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  80033d:	00 
  80033e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800345:	00 
  800346:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  80034d:	e8 74 14 00 00       	call   8017c6 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003aa:	00 
  8003ab:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  8003b2:	00 
  8003b3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003ba:	00 
  8003bb:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  8003c2:	e8 ff 13 00 00       	call   8017c6 <_panic>
...
sys_e1000_transmit(char *pkt, size_t length)
{
  ...
  8003f9:	b8 0f 00 00 00       	mov    $0xf,%eax
...
sys_e1000_receive(char *pkt, size_t *length)
{
  ...
  80041a:	b8 10 00 00 00       	mov    $0x10,%eax
...
sys_e1000_get_mac(uint8_t *mac_addr)
{
  ...
  80043b:	b8 11 00 00 00       	mov    $0x11,%eax
...
sys_exec(uint32_t eip, uint32_t esp, void * v_ph, uint32_t phnum)
{
  ...
  80045e:	b8 12 00 00 00       	mov    $0x12,%eax
  800463:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800466:	8b 55 08             	mov    0x8(%ebp),%edx
  800469:	8b 5d 10             	mov    0x10(%ebp),%ebx
  80046c:	8b 7d 14             	mov    0x14(%ebp),%edi
  ...
  800473:	7e 28                	jle    80049d <sys_exec+0x4d>
		panic("syscall %d returned %d (> 0)", num, ret);
  800475:	89 44 24 10          	mov    %eax,0x10(%esp)
  800479:	c7 44 24 0c 12 00 00 	movl   $0x12,0xc(%esp)
  800480:	00 
  800481:	c7 44 24 08 4a 26 80 	movl   $0x80264a,0x8(%esp)
  800488:	00 
  800489:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800490:	00 
  800491:	c7 04 24 67 26 80 00 	movl   $0x802667,(%esp)
  800498:	e8 29 13 00 00       	call   8017c6 <_panic>
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800649:	e8 c0 fb ff ff       	call   80020e <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800747:	e8 6f fa ff ff       	call   8001bb <sys_page_map>
  ...
  800782:	e8 34 fa ff ff       	call   8001bb <sys_page_map>
...
err:
  ...
  8007ab:	e8 5e fa ff ff       	call   80020e <sys_page_unmap>
	return r;
...
alloc_sockfd(int sockid)
{
  ...
  800e9c:	e8 c6 f2 ff ff       	call   800167 <sys_page_alloc>
...
devpipe_close(struct Fd *fd)
{
  ...
  801300:	e8 09 ef ff ff       	call   80020e <sys_page_unmap>
  ...
  801318:	e8 f1 ee ff ff       	call   80020e <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8013b4:	75 41                	jne    8013f7 <devpipe_write+0x6b>
			...
			sys_yield();
  8013b6:	e8 8d ed ff ff       	call   800148 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801434:	75 31                	jne    801467 <devpipe_read+0x63>
			...
			sys_yield();
  801436:	e8 0d ed ff ff       	call   800148 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  8014a7:	e8 bb ec ff ff       	call   800167 <sys_page_alloc>
  ...
  8014e1:	e8 81 ec ff ff       	call   800167 <sys_page_alloc>
  ...
  801510:	e8 52 ec ff ff       	call   800167 <sys_page_alloc>
  ...
  801549:	e8 6d ec ff ff       	call   8001bb <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80168d:	e8 08 ea ff ff       	call   80009a <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8016b7:	eb 2a                	jmp    8016e3 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8016b9:	e8 8a ea ff ff       	call   800148 <sys_yield>
	int c;
  ...
  8016c0:	e8 f3 e9 ff ff       	call   8000b8 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  8016ff:	e8 96 e9 ff ff       	call   80009a <sys_cputs>
}
  801704:	c9                   	leave  
  801705:	c3                   	ret    
...
opencons(void)
{
  ...
  801798:	e8 ca e9 ff ff       	call   800167 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8017d7:	e8 4d e9 ff ff       	call   800129 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  801849:	e8 4c e8 ff ff       	call   80009a <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8018b2:	e8 e3 e7 ff ff       	call   80009a <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80225e:	e8 1a e1 ff ff       	call   80037d <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8022d6:	e8 7f e0 ff ff       	call   80035a <sys_ipc_try_send>
	if (r == 0) return;
  ...
  8022e5:	e8 5e de ff ff       	call   800148 <sys_yield>
  ...
  8022fc:	e8 59 e0 ff ff       	call   80035a <sys_ipc_try_send>
		pg = (void *) KERNBASE;
