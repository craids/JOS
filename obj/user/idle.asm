...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 60 	movl   $0x802660,0x803000
  800040:	26 80 00 
...
exit(void)
{
  ...
  800095:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800098:	e8 fd 05 00 00       	call   80069a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800115:	00 
  800116:	c7 44 24 08 6f 26 80 	movl   $0x80266f,0x8(%esp)
  80011d:	00 
  80011e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800125:	00 
  800126:	c7 04 24 8c 26 80 00 	movl   $0x80268c,(%esp)
  80012d:	e8 a4 16 00 00       	call   8017d6 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001a7:	00 
  8001a8:	c7 44 24 08 6f 26 80 	movl   $0x80266f,0x8(%esp)
  8001af:	00 
  8001b0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001b7:	00 
  8001b8:	c7 04 24 8c 26 80 00 	movl   $0x80268c,(%esp)
  8001bf:	e8 12 16 00 00       	call   8017d6 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001fa:	00 
  8001fb:	c7 44 24 08 6f 26 80 	movl   $0x80266f,0x8(%esp)
  800202:	00 
  800203:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020a:	00 
  80020b:	c7 04 24 8c 26 80 00 	movl   $0x80268c,(%esp)
  800212:	e8 bf 15 00 00       	call   8017d6 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80024d:	00 
  80024e:	c7 44 24 08 6f 26 80 	movl   $0x80266f,0x8(%esp)
  800255:	00 
  800256:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80025d:	00 
  80025e:	c7 04 24 8c 26 80 00 	movl   $0x80268c,(%esp)
  800265:	e8 6c 15 00 00       	call   8017d6 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a0:	00 
  8002a1:	c7 44 24 08 6f 26 80 	movl   $0x80266f,0x8(%esp)
  8002a8:	00 
  8002a9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b0:	00 
  8002b1:	c7 04 24 8c 26 80 00 	movl   $0x80268c,(%esp)
  8002b8:	e8 19 15 00 00       	call   8017d6 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002f3:	00 
  8002f4:	c7 44 24 08 6f 26 80 	movl   $0x80266f,0x8(%esp)
  8002fb:	00 
  8002fc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800303:	00 
  800304:	c7 04 24 8c 26 80 00 	movl   $0x80268c,(%esp)
  80030b:	e8 c6 14 00 00       	call   8017d6 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800346:	00 
  800347:	c7 44 24 08 6f 26 80 	movl   $0x80266f,0x8(%esp)
  80034e:	00 
  80034f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800356:	00 
  800357:	c7 04 24 8c 26 80 00 	movl   $0x80268c,(%esp)
  80035e:	e8 73 14 00 00       	call   8017d6 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003bb:	00 
  8003bc:	c7 44 24 08 6f 26 80 	movl   $0x80266f,0x8(%esp)
  8003c3:	00 
  8003c4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003cb:	00 
  8003cc:	c7 04 24 8c 26 80 00 	movl   $0x80268c,(%esp)
  8003d3:	e8 fe 13 00 00       	call   8017d6 <_panic>
...
sys_e1000_receive(char *pkt, size_t *length)
{
  ...
  80042b:	b8 10 00 00 00       	mov    $0x10,%eax
...
sys_e1000_get_mac(uint8_t *mac_addr)
{
  ...
  80044c:	b8 11 00 00 00       	mov    $0x11,%eax
...
sys_exec(uint32_t eip, uint32_t esp, void * v_ph, uint32_t phnum)
{
  ...
  800467:	83 ec 2c             	sub    $0x2c,%esp
	...
	asm volatile("int %1\n"
  80046a:	be 00 00 00 00       	mov    $0x0,%esi
  80046f:	b8 12 00 00 00       	mov    $0x12,%eax
  800474:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800477:	8b 55 08             	mov    0x8(%ebp),%edx
  80047a:	8b 5d 10             	mov    0x10(%ebp),%ebx
  80047d:	8b 7d 14             	mov    0x14(%ebp),%edi
  ...
  800484:	7e 28                	jle    8004ae <sys_exec+0x4d>
		panic("syscall %d returned %d (> 0)", num, ret);
  800486:	89 44 24 10          	mov    %eax,0x10(%esp)
  80048a:	c7 44 24 0c 12 00 00 	movl   $0x12,0xc(%esp)
  800491:	00 
  800492:	c7 44 24 08 6f 26 80 	movl   $0x80266f,0x8(%esp)
  800499:	00 
  80049a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8004a1:	00 
  8004a2:	c7 04 24 8c 26 80 00 	movl   $0x80268c,(%esp)
  8004a9:	e8 28 13 00 00       	call   8017d6 <_panic>
...
sys_exec(uint32_t eip, uint32_t esp, void * v_ph, uint32_t phnum)
{
  ...
  8004b8:	66 90                	xchg   %ax,%ax
  8004ba:	66 90                	xchg   %ax,%ax
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8005af:	8b 04 95 18 27 80 00 	mov    0x802718(,%edx,4),%eax
  ...
  8005ca:	c7 04 24 9c 26 80 00 	movl   $0x80269c,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800659:	e8 c1 fb ff ff       	call   80021f <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800757:	e8 70 fa ff ff       	call   8001cc <sys_page_map>
  ...
  800792:	e8 35 fa ff ff       	call   8001cc <sys_page_map>
...
err:
  ...
  8007bb:	e8 5f fa ff ff       	call   80021f <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80081f:	c7 04 24 dd 26 80 00 	movl   $0x8026dd,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8008f7:	c7 04 24 f9 26 80 00 	movl   $0x8026f9,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8009b0:	c7 04 24 bc 26 80 00 	movl   $0x8026bc,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800c06:	c7 44 24 0c 2c 27 80 	movl   $0x80272c,0xc(%esp)
  800c0d:	00 
  800c0e:	c7 44 24 08 33 27 80 	movl   $0x802733,0x8(%esp)
  800c15:	00 
  800c16:	c7 44 24 04 9b 00 00 	movl   $0x9b,0x4(%esp)
  800c1d:	00 
  800c1e:	c7 04 24 48 27 80 00 	movl   $0x802748,(%esp)
  800c25:	e8 ac 0b 00 00       	call   8017d6 <_panic>
	assert(r <= PGSIZE);
  800c2a:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800c2f:	7e 24                	jle    800c55 <devfile_write+0xa5>
  800c31:	c7 44 24 0c 53 27 80 	movl   $0x802753,0xc(%esp)
  800c38:	00 
  800c39:	c7 44 24 08 33 27 80 	movl   $0x802733,0x8(%esp)
  800c40:	00 
  800c41:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
  800c48:	00 
  800c49:	c7 04 24 48 27 80 00 	movl   $0x802748,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800c90:	c7 44 24 0c 2c 27 80 	movl   $0x80272c,0xc(%esp)
  800c97:	00 
  800c98:	c7 44 24 08 33 27 80 	movl   $0x802733,0x8(%esp)
  800c9f:	00 
  800ca0:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800ca7:	00 
  800ca8:	c7 04 24 48 27 80 00 	movl   $0x802748,(%esp)
  800caf:	e8 22 0b 00 00       	call   8017d6 <_panic>
	assert(r <= PGSIZE);
  800cb4:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800cb9:	7e 24                	jle    800cdf <devfile_read+0x84>
  800cbb:	c7 44 24 0c 53 27 80 	movl   $0x802753,0xc(%esp)
  800cc2:	00 
  800cc3:	c7 44 24 08 33 27 80 	movl   $0x802733,0x8(%esp)
  800cca:	00 
  800ccb:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800cd2:	00 
  800cd3:	c7 04 24 48 27 80 00 	movl   $0x802748,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800da6:	c7 44 24 04 5f 27 80 	movl   $0x80275f,0x4(%esp)
  800dad:	00 
...
fd2sockid(int fd)
{
  ...
  800e65:	8b 0d 20 30 80 00    	mov    0x803020,%ecx
...
alloc_sockfd(int sockid)
{
  ...
  800eac:	e8 c7 f2 ff ff       	call   800178 <sys_page_alloc>
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  8011c7:	c7 44 24 0c 6b 27 80 	movl   $0x80276b,0xc(%esp)
  8011ce:	00 
  8011cf:	c7 44 24 08 33 27 80 	movl   $0x802733,0x8(%esp)
  8011d6:	00 
  8011d7:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  8011de:	00 
  8011df:	c7 04 24 80 27 80 00 	movl   $0x802780,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801225:	c7 44 24 0c 8c 27 80 	movl   $0x80278c,0xc(%esp)
  80122c:	00 
  80122d:	c7 44 24 08 33 27 80 	movl   $0x802733,0x8(%esp)
  801234:	00 
  801235:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  80123c:	00 
  80123d:	c7 04 24 80 27 80 00 	movl   $0x802780,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8012c0:	c7 44 24 04 98 27 80 	movl   $0x802798,0x4(%esp)
  8012c7:	00 
  ...
  8012e2:	00 00 00 
	stat->st_dev = &devpipe;
  8012e5:	c7 83 88 00 00 00 3c 	movl   $0x80303c,0x88(%ebx)
  8012ec:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  801310:	e8 0a ef ff ff       	call   80021f <sys_page_unmap>
  ...
  801328:	e8 f2 ee ff ff       	call   80021f <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801386:	c7 04 24 9f 27 80 00 	movl   $0x80279f,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8013c4:	75 41                	jne    801407 <devpipe_write+0x6b>
			...
			sys_yield();
  8013c6:	e8 8e ed ff ff       	call   800159 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801444:	75 31                	jne    801477 <devpipe_read+0x63>
			...
			sys_yield();
  801446:	e8 0e ed ff ff       	call   800159 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  8014b7:	e8 bc ec ff ff       	call   800178 <sys_page_alloc>
  ...
  8014f1:	e8 82 ec ff ff       	call   800178 <sys_page_alloc>
  ...
  801520:	e8 53 ec ff ff       	call   800178 <sys_page_alloc>
  ...
  801559:	e8 6e ec ff ff       	call   8001cc <sys_page_map>
  ...
  801564:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  ...
  801579:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801640:	c7 44 24 04 b7 27 80 	movl   $0x8027b7,0x4(%esp)
  801647:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80169d:	e8 09 ea ff ff       	call   8000ab <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8016c7:	eb 2a                	jmp    8016f3 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8016c9:	e8 8b ea ff ff       	call   800159 <sys_yield>
	int c;
  ...
  8016d0:	e8 f4 e9 ff ff       	call   8000c9 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80170f:	e8 97 e9 ff ff       	call   8000ab <sys_cputs>
}
  801714:	c9                   	leave  
  801715:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  80176b:	8b 15 58 30 80 00    	mov    0x803058,%edx
...
opencons(void)
{
  ...
  8017a8:	e8 cb e9 ff ff       	call   800178 <sys_page_alloc>
		return r;
  ...
  8017b3:	8b 15 58 30 80 00    	mov    0x803058,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8017e1:	8b 35 00 30 80 00    	mov    0x803000,%esi
  8017e7:	e8 4e e9 ff ff       	call   80013a <sys_getenvid>
  ...
  801802:	c7 04 24 c4 27 80 00 	movl   $0x8027c4,(%esp)
  ...
  801818:	e8 51 00 00 00       	call   80186e <vcprintf>
	cprintf("\n");
  80181d:	c7 04 24 b0 27 80 00 	movl   $0x8027b0,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  801859:	e8 4d e8 ff ff       	call   8000ab <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8018c2:	e8 e4 e7 ff ff       	call   8000ab <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8019c8:	0f be 80 e7 27 80 00 	movsbl 0x8027e7(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801ae3:	ff 24 8d 20 29 80 00 	jmp    *0x802920(,%ecx,4)
  ...
  801baf:	c7 44 24 08 45 27 80 	movl   $0x802745,0x8(%esp)
  801bb6:	00 
  ...
  801be1:	b8 f8 27 80 00       	mov    $0x8027f8,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80226e:	e8 1b e1 ff ff       	call   80038e <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8022e6:	e8 80 e0 ff ff       	call   80036b <sys_ipc_try_send>
	if (r == 0) return;
  ...
  8022f5:	e8 5f de ff ff       	call   800159 <sys_yield>
  ...
  80230c:	e8 5a e0 ff ff       	call   80036b <sys_ipc_try_send>
		pg = (void *) KERNBASE;
  ...
  802321:	c7 44 24 08 e8 2a 80 	movl   $0x802ae8,0x8(%esp)
  802328:	00 
  802329:	c7 44 24 04 48 00 00 	movl   $0x48,0x4(%esp)
  802330:	00 
  802331:	c7 04 24 f6 2a 80 00 	movl   $0x802af6,(%esp)
