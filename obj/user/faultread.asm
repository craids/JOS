	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 88 26 80 00 	movsbl 0x802688(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800363:	ff 24 8d c0 27 80 00 	jmp    *0x8027c0(,%ecx,4)
  ...
  80042f:	c7 44 24 08 5d 2a 80 	movl   $0x802a5d,0x8(%esp)
  800436:	00 
  ...
  800461:	b8 99 26 80 00       	mov    $0x802699,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b30:	00 
  800b31:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800b38:	00 
  800b39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b40:	00 
  800b41:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bc2:	00 
  800bc3:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800bca:	00 
  800bcb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bd2:	00 
  800bd3:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c15:	00 
  800c16:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800c1d:	00 
  800c1e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c25:	00 
  800c26:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c68:	00 
  800c69:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800c70:	00 
  800c71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c78:	00 
  800c79:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cbb:	00 
  800cbc:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800cc3:	00 
  800cc4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ccb:	00 
  800ccc:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d0e:	00 
  800d0f:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800d16:	00 
  800d17:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d1e:	00 
  800d1f:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d61:	00 
  800d62:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800d69:	00 
  800d6a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d71:	00 
  800d72:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800dd6:	00 
  800dd7:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800dde:	00 
  800ddf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de6:	00 
  800de7:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
sys_exec(uint32_t eip, uint32_t esp, void * v_ph, uint32_t phnum)
{
  ...
  800eac:	00 
  800ead:	c7 44 24 08 87 29 80 	movl   $0x802987,0x8(%esp)
  800eb4:	00 
  800eb5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ebc:	00 
  800ebd:	c7 04 24 a4 29 80 00 	movl   $0x8029a4,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800fcf:	8b 04 95 30 2a 80 00 	mov    0x802a30(,%edx,4),%eax
  ...
  800fea:	c7 04 24 b4 29 80 00 	movl   $0x8029b4,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80123f:	c7 04 24 f5 29 80 00 	movl   $0x8029f5,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801317:	c7 04 24 11 2a 80 00 	movl   $0x802a11,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8013d0:	c7 04 24 d4 29 80 00 	movl   $0x8029d4,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801626:	c7 44 24 0c 44 2a 80 	movl   $0x802a44,0xc(%esp)
  80162d:	00 
  80162e:	c7 44 24 08 4b 2a 80 	movl   $0x802a4b,0x8(%esp)
  801635:	00 
  801636:	c7 44 24 04 9b 00 00 	movl   $0x9b,0x4(%esp)
  80163d:	00 
  80163e:	c7 04 24 60 2a 80 00 	movl   $0x802a60,(%esp)
  801645:	e8 ac 0b 00 00       	call   8021f6 <_panic>
	assert(r <= PGSIZE);
  80164a:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80164f:	7e 24                	jle    801675 <devfile_write+0xa5>
  801651:	c7 44 24 0c 6b 2a 80 	movl   $0x802a6b,0xc(%esp)
  801658:	00 
  801659:	c7 44 24 08 4b 2a 80 	movl   $0x802a4b,0x8(%esp)
  801660:	00 
  801661:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
  801668:	00 
  801669:	c7 04 24 60 2a 80 00 	movl   $0x802a60,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8016b0:	c7 44 24 0c 44 2a 80 	movl   $0x802a44,0xc(%esp)
  8016b7:	00 
  8016b8:	c7 44 24 08 4b 2a 80 	movl   $0x802a4b,0x8(%esp)
  8016bf:	00 
  8016c0:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  8016c7:	00 
  8016c8:	c7 04 24 60 2a 80 00 	movl   $0x802a60,(%esp)
  8016cf:	e8 22 0b 00 00       	call   8021f6 <_panic>
	assert(r <= PGSIZE);
  8016d4:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8016d9:	7e 24                	jle    8016ff <devfile_read+0x84>
  8016db:	c7 44 24 0c 6b 2a 80 	movl   $0x802a6b,0xc(%esp)
  8016e2:	00 
  8016e3:	c7 44 24 08 4b 2a 80 	movl   $0x802a4b,0x8(%esp)
  8016ea:	00 
  8016eb:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  8016f2:	00 
  8016f3:	c7 04 24 60 2a 80 00 	movl   $0x802a60,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8017c6:	c7 44 24 04 77 2a 80 	movl   $0x802a77,0x4(%esp)
  8017cd:	00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801be7:	c7 44 24 0c 83 2a 80 	movl   $0x802a83,0xc(%esp)
  801bee:	00 
  801bef:	c7 44 24 08 4b 2a 80 	movl   $0x802a4b,0x8(%esp)
  801bf6:	00 
  801bf7:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  801bfe:	00 
  801bff:	c7 04 24 98 2a 80 00 	movl   $0x802a98,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801c45:	c7 44 24 0c a4 2a 80 	movl   $0x802aa4,0xc(%esp)
  801c4c:	00 
  801c4d:	c7 44 24 08 4b 2a 80 	movl   $0x802a4b,0x8(%esp)
  801c54:	00 
  801c55:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  801c5c:	00 
  801c5d:	c7 04 24 98 2a 80 00 	movl   $0x802a98,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ce0:	c7 44 24 04 b0 2a 80 	movl   $0x802ab0,0x4(%esp)
  801ce7:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801da6:	c7 04 24 b7 2a 80 00 	movl   $0x802ab7,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  802060:	c7 44 24 04 cf 2a 80 	movl   $0x802acf,0x4(%esp)
  802067:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  802222:	c7 04 24 dc 2a 80 00 	movl   $0x802adc,(%esp)
  ...
  802238:	e8 b6 de ff ff       	call   8000f3 <vcprintf>
	cprintf("\n");
  80223d:	c7 04 24 7c 26 80 00 	movl   $0x80267c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802321:	c7 44 24 08 00 2b 80 	movl   $0x802b00,0x8(%esp)
  802328:	00 
  802329:	c7 44 24 04 48 00 00 	movl   $0x48,0x4(%esp)
  802330:	00 
  802331:	c7 04 24 0e 2b 80 00 	movl   $0x802b0e,(%esp)
